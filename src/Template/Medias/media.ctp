		...
		<div class="expand">
			...
			<table>
				...
				<tr>
					...
					<td><input class="href" name="href" type="text" value="<?php echo $this->Url->build($media->file); ?>"></td>
				</tr>
				<tr>
				...
				<input type="hidden" name="file" value="<?php echo $this->Url->build($media->file); ?>" class="file">
			</table>
		</div>
</div>
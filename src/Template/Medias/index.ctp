	 ...
	 ?>
		...
		<div id="plupload">
		    <div id="droparea" href="#">
		    	...
		    	<p class="small">(<?php echo __d('media',implode(', ', $extensions).' seulement'); ?>)</p>
		    </div>
		</div>
...
<?php $this->Html->script('/media/js/jquery.form.js',array('block'=>true)); ?>
<?php $this->Html->script('/media/js/plupload.js',array('block'=>true)); ?>
<?php $this->Html->script('/media/js/plupload.html5.js',array('block'=>true)); ?>
<?php $this->Html->script('/media/js/plupload.flash.js',array('block'=>true)); ?>
